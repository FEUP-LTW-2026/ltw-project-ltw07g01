<?php function drawAboutUs(Session $session): void
{ ?>
    <main class="about-page">
        ...
        <section class="about-intro">
            <div class="about-intro-text">
                ...
                <p>Founded in Porto, CUBO GYM was born from a simple belief: fitness should be accessible, motivating,
                    and community-driven.</p>
                <p>From day one, we set out to build more than a gym — a space where every member, regardless of level,
                    feels at home and challenged.</p>
                <p>Today we operate across multiple locations in Porto and Braga, with over 10,000 members and 25+
        ...
        <section class="about-values">
            ...
            <div>
                <article>
                    ...
                    <h3>Community</h3>
                    <p>We train together, grow together. Every class, every session builds connections that last beyond
                        the gym floor.</p>
                </article>
                <article>
                    <i class="fa fa-medal"></i>
                    <h3>Quality</h3>
                    <p>Top-tier equipment, certified trainers, and programmes designed to deliver real, measurable
                        results.</p>
                </article>
                <article>
                    <i class="fa fa-bullseye"></i>
                    <h3>Results</h3>
                    <p>Whatever your goal — weight loss, strength, endurance — our trainers and classes are built around
                        your success.</p>
                </article>
                <article>
