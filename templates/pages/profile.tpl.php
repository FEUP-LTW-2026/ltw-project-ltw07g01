            ...
            <section class="profile-card">
                <div class="profile-info">
                    ...
                    <div class="user-meta">
                        ...
                        <?php if ($isOwnProfile && $daysLeft !== null): ?>
                            <p class="membership-days">
                                <?php if ($daysLeft === 0): ?>
                                    <i class="fa fa-triangle-exclamation"></i> Membership expired
                                <?php else: ?>
                                    <i class="fa fa-calendar"></i> <?= $daysLeft ?> days until renewal
                                <?php endif; ?>
                            </p>
                        <?php endif; ?>
                        ...
                        <?php foreach ($minutesByDay as $day => $mins):
                            ...
                            <div class="bar-group">
                                <div class="bar" style="height: <?= $barHeight ?>px;"
                                     data-time="<?= htmlspecialchars($time) ?>"></div>
                ...
                fetch('profile.php', {
                    ...
                    .then(function (data) {
                        if (!data.ok) {
                            if (btn) {
                                btn.disabled = false;
                                btn.innerHTML = '<i class="fa fa-ban"></i> Cancel Membership';
                            }
                            return;
                        }
                        if (btn) btn.remove();
