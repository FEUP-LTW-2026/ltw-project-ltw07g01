/* schedule.js — Cubo Gym Schedule Page */
(function () {
    'use strict';
    ...
    dynamicContent.addEventListener('click', function (e) {
        ...
        // Row click (skip if user clicked a button or link inside)
    ...
    window.openModal = function (classId) {
        ...
        if (SC.isClient) {
            if (cls.is_enrolled) {
                footer.innerHTML = '<span class="sc-modal-enrolled-msg"><i class="fa fa-circle-check"></i> You\'re enrolled in this class</span>';
            } else if (!cls.is_full) {
